...
public abstract class Idle extends Abstract {

	private static transient volatile Logger log = null;
	public static Logger getLog(){
		if(log == null){
				log = LogManager.getLogger(Idle.class);
		}
		return log;
	}
	...
	private static Idle sensor = null;
	/*********************************************************/
	...
	/*********************************************************************************/
	/* Wait till the user has been idle for 60 seconds */
	/* In milli seconds ! */
	protected final long IDLE_TIMEOUT = 60 * 1000;
	//protected static long IDLE_TIMEOUT = 5 * 1000 ;
	
    /* Returns milliseconds */
    abstract public Integer senseIdleTime();

	public Boolean isIdle() {
		Integer idle = senseIdleTime();
		if(idle != null){
