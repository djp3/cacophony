...
public class AccelerometerWindows extends Accelerometer{
	
    private static transient volatile Logger log = null;
	public static Logger getLog(){
		if(log == null){
			log = LogManager.getLogger(AccelerometerWindows.class);
		}
		return log;
	}
	...
	@Override
	public List<Double> senseAccelerometer() {
		int[] a = readSMS();
		if(a.length >= 3){
